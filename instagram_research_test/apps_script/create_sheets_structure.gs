...
var SHEETS_CONFIG = [
  {
    ...
    hints: [
      ...
      "одним предложением: что рассказывает карусель целиком",
      "дословный CTA с последнего слайда; пусто если не карусель"
    ]
  },
  {
  ...
  },
  {
    ...
    hints: [
      ...
      "нестандартные/креативные решения на лендинге: интерактив / анимация / необычный оффер"
    ]
  },
  {
  ...
  },
  {
    ...
    hints: [
      ...
      "кол-во комментариев на момент сбора",
      ...
      "что заставляет досмотреть: факт / история / спорный тезис / вопрос без ответа",
      "структура Reel в формате X → Y → Z, макс 3 элемента",
      "вопрос / факт / история / провокация / обещание / не найдено",
      "лайки / просмотры × 100, формат 1.23%",
      "просмотры / подписчики × 100, формат 45.2%",
      "да / нет — закреплён ли Reel в профиле",
      "дата публикации в формате дд.мм.гггг",
      "длительность в секундах, формат 62с",
      "хэштеги из подписи через запятую",
      "день недели публикации: понедельник / вторник / ..."
    ]
  },
  {
    name: "Комментарии",
