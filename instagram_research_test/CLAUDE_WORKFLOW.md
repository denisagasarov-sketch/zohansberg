...
Перед любой задачей сначала прочитай CLAUDE_MASTER_RULES.md и соблюдай его.
Если правила задачи конфликтуют с CLAUDE_MASTER_RULES.md, используй более строгие правила.
