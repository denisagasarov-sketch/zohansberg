...
EXPECTED_POSTS  = 3
PROMPT_VERSION  = "v4"           # bumped: expanded CTA verb list, bio-link phrasing fix
...
# Includes both вы-forms (-те) and ты-forms (-й/-и/-сь) added in prompt v4
_STRONG_VERBS_RE = re.compile(
    r"\b(?:"
    r"пишите|пиши|напишите|напиши|"
    r"оставьте|оставляй|"
    r"переходите|переходи|перейдите|перейди|"
    r"заполните|заполни|"
    r"регистрируйтесь|зарегистрируйтесь|"
    r"отправьте|отправь|забронируйте|забронируй|"
    r"подпишитесь|подпишись|"
    r"нажмите|нажми|жмите|жми|"
    r"запишитесь|запишись|"
    r"приходите|приходи|кликните|кликни|"
    r"получите\s+доступ|получи|"
    r"купите|купи|"
    r"узнайте|узнай|"
    r"смотрите|смотри|"
    r"скачайте|скачай|"
...
━━━ ПРАВИЛА CTA ━━━
CTA (призыв к действию) — ТОЛЬКО явный призыв к действию с глаголом-действием,
когда текст прямо просит читателя что-то СДЕЛАТЬ.

ВАЛИДНЫЙ CTA содержит один из глаголов (или его форму):
пишите / напишите / пиши / оставьте / оставляй / переходите / переходи / жмите / жми /
заполните / регистрируйтесь / нажмите / запишитесь / запишись / получите / получи /
купите / купи / узнайте / узнай / смотрите / смотри / скачайте / скачай /
забирайте / забирай / бери / берите / подпишитесь / подпишись и т.п.

Примеры ВАЛИДНОГО CTA:
  - "пишите «АНКЕТА» в директ и комментарии"
  - "оставляй заявку по ссылке в bio"
  - "переходи по ссылке в профиле"
  - "заполните анкету"
  - "напишите слово «консультация» в комментариях"
  - "скачай бесплатный чек-лист по ссылке в bio"

НЕ является CTA:
  - тезис, инсайт, прогноз, спойлер, тема, вопрос, обещание, риторический вопрос
  - "Спойлер: в 2026 году..."
  - "как прогнозировать результаты"
  - "что изменится в маркетинге"
  - "почему большинство это проспит"
  - "ссылка в bio" или "подробности в шапке профиля" — без глагола действия

Если CTA ведёт в директ — пиши точную фразу дословно из текста.
Если CTA ведёт по ссылке в bio — пиши дословно всю фразу ("оставляй заявку по ссылке в bio").
...
{{
  ...
  "Какой CTA": "<ТОЛЬКО явный призыв с глаголом действия (пиши/переходи/оставляй/узнай/скачай/подпишись и т.п.) — дословно из текста или '' — макс 180 символов>",
...
- "Какой CTA" — только если есть явный глагол-действие в тексте; иначе "". Если CTA ведёт по ссылке в bio — пиши дословно всю фразу, а не просто "ссылка в bio"
