...
3. carousel_cta — CTA с последнего слайда — только если есть явный призыв к действию с глаголом:
   купи / запишись / переходи / пиши / регистрируйся / получи / оставляй / жми / смотри / узнай / скачай / забирай / подпишись / бери.
   Риторические вопросы, утверждения, описания, эмоциональные крючки — "не найдено".
   Если нашёл — пиши дословно текст с последнего слайда. Максимум 100 символов.
